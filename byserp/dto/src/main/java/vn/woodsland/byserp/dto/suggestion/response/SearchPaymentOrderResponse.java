...
@Data
@NoArgsConstructor
public class SearchPaymentOrderResponse extends RESPONSE {

    private List<ItemData> rows = new ArrayList<>();

    private Long total;

    public SearchPaymentOrderResponse(Page<SearchPaymentOrderModal> page) {
    ...
    @Data
    public static class ItemData extends SearchPaymentOrderModal {
    }
}
