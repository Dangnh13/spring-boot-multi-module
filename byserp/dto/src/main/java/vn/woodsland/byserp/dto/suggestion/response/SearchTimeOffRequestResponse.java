...
@Data
@NoArgsConstructor
public class SearchTimeOffRequestResponse extends RESPONSE {

    private List<ItemData> rows = new ArrayList<>();

    private Long total;

    public SearchTimeOffRequestResponse(Page<SearchTimeOffRequestModal> page) {
    ...
    @Data
    public static class ItemData extends SearchTimeOffRequestModal {
    }
}
